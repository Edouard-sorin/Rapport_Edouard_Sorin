...
```{r 21, fig.cap = "Valeur du F de Fisher montrant l’influence du statut seul en interaction avec la variété et la parcelle sur le spectre de réflectance"}
...
```{r 23, eval = TRUE, fig.cap = "Distribution des réflectances pour la longueur d’onde 2000 nm"}
...
\vfill
\newpage
## Comparaison des performances des trois méthodes de prédiction du statut HLB à partir des spectres réflectance
...
knitr::kable((ML.36), caption="Paramètres de performance de la prédiction du statut HLB par les trois méthodes d'apprentissage supervisé", longtable = TRUE, booktabs = TRUE , digits = 1, escape = FALSE) %>%
kableExtra::kable_styling(bootstrap_options = "striped", full_width = FALSE)
